<div class="subcontmodal" id="instruccregistro">
	<div class="subinstrucc" id="sub1instrucreg">
		<p>Registro EasyCheck</p>	
	</div>
	<div class="subinstrucc" id="sub2instrucreg">
		<p>Elija un tipo de cuenta de usuario</p>
	</div>
</div>
<div class="subcontmodal" id="containerusertypes">
	<div onclick="checkuserregist()" class="subcontainerusertypes" id="coordacad">
		...
		<div class="infousertype" id="infocoodacad">
			<div>
				<p>Crear cuenta tipo</p>
			</div>
			<div class="boldletter">
				<p>Coordinador de Academia</p>
			</div>
		</div>
	</div>
...
<div class="subcontmodal" id="ingresarpart">
	<p>¿Ya tienes una cuenta?</p><button onclick="hidetologin();">Ingresar</button>
</div>